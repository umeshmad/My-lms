        ...
        <nav className="bg-linear-to-r from-cyan-50 via-blue-50 to-teal-50 shadow-2xl flex w-full justify-between items-center sticky top-0 z-50 backdrop-blur-sm h-25">
            ...
            <div className="flex items-center pr-8">
                {isLoggedIn?(
                    ...
                    <li><Link to='/tutors' className="text-blue-700 font-bold text-lg px-5 py-2.5 rounded-xl transition-all duration-300 hover:bg-linear-to-r hover:from-green-400 hover:to-teal-500 hover:text-white hover:shadow-lg hover:-translate-y-1 hover:border-2 hover:border-blue-600">Tutors</Link></li>
